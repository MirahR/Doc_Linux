...
int main()
{
    ...
    vector<string> attributsDefault;
    vector<string> attributsPersonnalises;
    ...
    while (ajouter)
    {
        ...
        case 1:
            while (continuer)
            {
                ...
                attributsDefault = ajouterAttributParDefault(attributsDefault);
                continuer = contAjout();
            }
            break;
        case 2:
            while (continuer)
            {
                ...
                typeAttributs = ajouterTypeAttributParDefault(typeAttributs);
                attributsPersonnalises = ajouterAttributPersonnaliser(attributsPersonnalises);
                continuer = contAjout();
            }
            break;
        case 4:
            ...
            break;
        case 3:
            affichageAttribut(attributsDefault, nomClasse);
            cout << "Affichage personnalise\n";
            affichageAttribut(attributsPersonnalises, nomClasse);
